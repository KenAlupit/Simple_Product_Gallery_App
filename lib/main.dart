            ...
            child: Padding(
              ...
              child: ListView(
                ...
                children: const [
                  ...
                  ProductCard(
                    title: 'MX3 Capsule',
                    imageUrl: 'assets/images/mx3.jpg',
                    price: 909,
                    description: 'MX3 Natural Pure G. Mangostana Capsule or commonly known as MX3 Capsule is a natural food supplement that is rich in xanthone- a natural chemical extracted from the pericarp of mangosteen fruit (Garcinia Mangostana L.) and has powerful antioxidant and anti-inflammatory properties that help boost the immune system.',
                  ),
                  ProductCard(
                    title: 'SCED Panyawan Herbal Capsule',
                    imageUrl: 'assets/images/panyawan.jpg',
                    price: 1500,
                    description: 'Panyawan Plus Herbal Capsule is a Food Supplement made from powerful traditional plants (Panyawan/ Makabuhay, Mangosteen, Luyang Dilaw, Banaba, Garlic). It can help to reduce your blood pressure, and is also tested and proven by the experts and users that it can help to those who have: Diabetes, Insomnia, Cyst, Goiter, Skin Allergy, Irregular bowel movements, Urinary Tract Infection, Myoma, Breast Cancer, Over Fatigue, Dengue Fever and Flu, regularizes women’s menstruation disorder, can discharge kidney stones and lots of benefits for your good immune system.',
                  ),
                  ProductCard(
                    title: 'Alaxan FR',
